...
print(" <<<<<< Toutes les operations doivent etre dans des parantheses >>>>>> \n\n -> Les nombres autorises sont les nombres allant de 0...9 \n\n \t\t -> Les operteurs qui sont autorises sont (+, -, *, /, et le modulo) \n")
